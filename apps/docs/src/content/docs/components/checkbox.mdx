...
| ARIA/state selectors used by the recipe | `[aria-checked]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-control-height`, `--simurgh-control-padding`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted-foreground`, `--simurgh-primary`, `--simurgh-primary-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
