...
| Stable DOM parts | `[data-slot="checkbox"]` |
| Stable data attributes | `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-checked]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted-foreground`, `--simurgh-primary`, `--simurgh-primary-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
