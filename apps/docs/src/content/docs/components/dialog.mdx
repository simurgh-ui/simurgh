...
| Stable DOM parts | `[data-slot="dialog-close"]`, `[data-slot="dialog-content"]`, `[data-slot="dialog-description"]`, `[data-slot="dialog-overlay"]`, `[data-slot="dialog-title"]` |
| Stable data attributes | `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-disabled]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-shadow`, `--simurgh-surface` |
