...
Component selector: `simurgh-scroll-area`. The template's first native element is `div`.
...
| --- | --- | --- | --- |
| React | `ScrollArea` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `ScrollArea` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `ScrollAreaComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
| Stable DOM parts | `[data-slot="scroll-area"]` |
...
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-ring` |
