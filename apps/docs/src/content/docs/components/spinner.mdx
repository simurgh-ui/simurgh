...
Component selector: `simurgh-spinner`. The template's first native element is `span`. Angular host bindings: `{ role: 'status', '[attr.aria-label]': 'label', '[attr.aria-live]': "'polite'", '[attr.aria-busy]': "'true'", '[attr.data-state]': "'loading'", }`.
...
| --- | --- | --- | --- |
| React | `Spinner` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `Spinner` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `SpinnerComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
| --- | --- | --- | --- |
| Loading | Dedicated spinner loading primitive; provide context or an accessible loading label. | Dedicated spinner loading primitive; provide context or an accessible loading label. | Dedicated spinner loading primitive; provide context or an accessible loading label. |
...
| Stable data attributes | `[data-part]`, `[data-state]` |
