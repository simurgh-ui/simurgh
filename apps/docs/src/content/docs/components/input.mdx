...
| Stable DOM parts | `[data-slot="input"]` |
| Stable data attributes | `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-invalid]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-danger`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted`, `--simurgh-muted-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
