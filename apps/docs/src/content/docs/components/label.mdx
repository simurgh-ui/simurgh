...
```ts
import { Label } from '@simurgh-ui/vue/label';
import '@simurgh-ui/styles/label.css';
```
...
- React exports: `Label`
- Vue exports: `Label`
- Angular exports: `LabelComponent`
...
Inherited attributes: `LabelHTMLAttributes<HTMLLabelElement> & RefAttributes<HTMLLabelElement>`.

| Prop | Type | Default / requirement |
| --- | --- | --- |
| `children` | `ReactNode` | `undefined` |
| `ref` | `Ref<HTMLLabelElement> \| undefined` | `undefined` |
...
Component selector: `simurgh-label`. The template's first native element is `label`.
...
| --- | --- | --- | --- |
| React | `Label` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `Label` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `LabelComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
- Inspect the registry [manifest](https://github.com/simurgh-ui/simurgh/blob/main/packages/registry/registry.json) and framework
  ...
  [Vue](https://github.com/simurgh-ui/simurgh/blob/main/packages/vue/src/components/label.ts), or
  [Angular](https://github.com/simurgh-ui/simurgh/blob/main/packages/angular/src/components/label.ts).
