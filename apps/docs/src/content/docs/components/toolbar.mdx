...
| Stable DOM parts | `[data-slot="toolbar"]`, `[data-slot="toolbar-button"]` |
| Stable data attributes | `[data-slot]`, `[data-toolbar-item]` |
| ARIA/state selectors used by the recipe | `[aria-orientation]` |
| CSS custom properties consumed | `--simurgh-foreground`, `--simurgh-muted`, `--simurgh-radius`, `--simurgh-ring` |
