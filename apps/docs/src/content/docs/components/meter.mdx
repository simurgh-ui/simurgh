...
| --- | --- | --- | --- |
| React | `Meter` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `Meter` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `MeterComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
| Stable DOM parts | `[data-slot="meter"]` |
| Stable data attributes | `[data-slot]` |
| ARIA/state selectors used by the recipe | No ARIA state selector is used by this recipe. |
| CSS custom properties consumed | `--simurgh-accent`, `--simurgh-danger`, `--simurgh-muted`, `--simurgh-primary` |
