...
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Loading   | Supported with `loading={true}`; the component exposes its busy state and blocks duplicate interaction.                                                         | Supported with `:loading="true"`; the component exposes its busy state and blocks duplicate interaction.                                                         | Supported with `[loading]="true"`; the component exposes its busy state and blocks duplicate interaction.                                                         |
...
| Stable DOM parts | `[data-slot="button"]` |
| Stable data attributes | `[data-full-width]`, `[data-icon-only]`, `[data-size]`, `[data-slot]`, `[data-state]`, `[data-variant]` |
| ARIA/state selectors used by the recipe | No ARIA state selector is used by this recipe. |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-danger`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted`, `--simurgh-primary`, `--simurgh-primary-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
