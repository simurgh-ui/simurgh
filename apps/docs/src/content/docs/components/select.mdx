...
| Stable DOM parts | `[data-slot="button"]`, `[data-slot="checkbox"]`, `[data-slot="input"]`, `[data-slot="input-otp"]`, `[data-slot="menubar-item"]`, `[data-slot="native-select"]`, `[data-slot="pagination-link"]`, `[data-slot="select-content"]`, `[data-slot="select-option"]`, `[data-slot="select-trigger"]`, `[data-slot="toggle-group-item"]`, `[data-slot="toolbar-button"]` |
| Stable data attributes | `[data-density]`, `[data-highlighted]`, `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-disabled]`, `[aria-expanded]`, `[aria-selected]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-control-height`, `--simurgh-control-padding`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-item-height`, `--simurgh-muted`, `--simurgh-primary`, `--simurgh-radius`, `--simurgh-reference-width`, `--simurgh-ring`, `--simurgh-shadow`, `--simurgh-surface` |
