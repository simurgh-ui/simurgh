...
```ts
import { Select, SelectOption } from '@simurgh-ui/vue/select';
import '@simurgh-ui/styles/select.css';
```
...
```ts
import { SelectComponent, SelectOption } from '@simurgh-ui/angular/select';
import '@simurgh-ui/styles/select.css';
```
...
| Stable DOM parts | `[data-slot="select-content"]`, `[data-slot="select-option"]`, `[data-slot="select-trigger"]` |
...
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-duration`, `--simurgh-foreground`, `--simurgh-muted`, `--simurgh-primary`, `--simurgh-radius`, `--simurgh-reference-width`, `--simurgh-ring`, `--simurgh-shadow`, `--simurgh-surface` |
