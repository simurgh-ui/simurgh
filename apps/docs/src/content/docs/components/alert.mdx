...
| --- | --- | --- | --- |
| React | `Alert` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `Alert` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `AlertComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
| Error | Use urgent alert semantics for an error message when immediate announcement is required. | Use urgent alert semantics for an error message when immediate announcement is required. | Use urgent alert semantics for an error message when immediate announcement is required. |
...
| Stable data attributes | `[data-urgent]` |
