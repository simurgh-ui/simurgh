...
| Stable DOM parts | `[data-slot="disclosure"]`, `[data-slot="disclosure-content"]`, `[data-slot="disclosure-summary"]` |
| Stable data attributes | `[data-slot]`, `[data-state]` |
| ARIA/state selectors used by the recipe | No ARIA state selector is used by this recipe. |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
