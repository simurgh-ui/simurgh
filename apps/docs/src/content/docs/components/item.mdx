...
| Stable DOM parts | `[data-slot="item"]`, `[data-slot="item-actions"]`, `[data-slot="item-content"]`, `[data-slot="item-description"]`, `[data-slot="item-group"]`, `[data-slot="item-media"]`, `[data-slot="item-title"]` |
| Stable data attributes | `[data-highlighted]`, `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-disabled]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-muted`, `--simurgh-muted-foreground`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
