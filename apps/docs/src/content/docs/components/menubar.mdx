...
| --- | --- |
| Recipe classes | `.simurgh-item` |
| Stable DOM parts | `[data-slot="menubar"]`, `[data-slot="menubar-item"]`, `[data-slot="select-option"]` |
| Stable data attributes | `[data-density]`, `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-disabled]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-foreground`, `--simurgh-item-height`, `--simurgh-muted`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-surface` |
