...
```tsx
import { Badge, BadgeTone } from '@simurgh-ui/react/badge';
...
```ts
import { Badge, BadgeTone } from '@simurgh-ui/vue/badge';
import '@simurgh-ui/styles/badge.css';
```
...
```ts
import { BadgeComponent, BadgeTone } from '@simurgh-ui/angular/badge';
import '@simurgh-ui/styles/badge.css';
```
