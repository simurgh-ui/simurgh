...
Component selector: `simurgh-kbd`. The template's first native element is `kbd`.
...
| --- | --- | --- | --- |
| React | `Kbd` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Vue | `Kbd` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
| Angular | `KbdComponent` is standalone and required when using this component. | Content is optional unless the API requires a label or value. | None. |
...
| Stable DOM parts | `[data-slot="kbd"]` |
| Stable data attributes | `[data-slot]` |
| ARIA/state selectors used by the recipe | No ARIA state selector is used by this recipe. |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-foreground`, `--simurgh-muted`, `--simurgh-radius` |
