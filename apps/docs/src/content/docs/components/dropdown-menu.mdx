...
| --- | --- |
| Focus entry and exit (Tab / Shift+Tab) | Tab reaches the trigger; open-menu focus follows the rendered menu items. |
| Navigation and activation | Arrow Down/Up and Home/End move among enabled items; Enter or Space activates. |
| Escape | Closes when handled by the surrounding overlay interaction. |
...
| Stable data attributes | `[data-density]`, `[data-highlighted]`, `[data-simurgh-floating-content]`, `[data-simurgh-floating-reference]`, `[data-slot]` |
| ARIA/state selectors used by the recipe | `[aria-disabled]` |
| CSS custom properties consumed | `--simurgh-border`, `--simurgh-control-height`, `--simurgh-control-padding`, `--simurgh-foreground`, `--simurgh-item-height`, `--simurgh-muted`, `--simurgh-primary`, `--simurgh-radius`, `--simurgh-ring`, `--simurgh-shadow`, `--simurgh-surface` |
