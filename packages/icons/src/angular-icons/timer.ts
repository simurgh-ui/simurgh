...
import { definition } from '../definitions/timer.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-timer-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Timer extends IconSvgHost {
