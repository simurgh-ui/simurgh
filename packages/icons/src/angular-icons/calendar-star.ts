...
import { definition } from '../definitions/calendar-star.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-star-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarStar extends IconSvgHost {
