...
import { definition } from '../definitions/history-clock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-history-clock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class HistoryClock extends IconSvgHost {
