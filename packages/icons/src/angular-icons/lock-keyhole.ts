...
import { definition } from '../definitions/lock-keyhole.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-lock-keyhole-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LockKeyhole extends IconSvgHost {
