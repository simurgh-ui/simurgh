...
import { definition } from '../definitions/stopwatch.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-stopwatch-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Stopwatch extends IconSvgHost {
