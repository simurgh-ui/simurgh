...
import { definition } from '../definitions/train.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-train-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Train extends IconSvgHost {
