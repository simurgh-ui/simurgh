...
import { definition } from '../definitions/skip-previous.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-skip-previous-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SkipPrevious extends IconSvgHost {
