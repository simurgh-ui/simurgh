...
import { definition } from '../definitions/key.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-key-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Key extends IconSvgHost {
