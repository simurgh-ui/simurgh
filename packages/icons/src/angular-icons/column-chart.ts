...
import { definition } from '../definitions/column-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-column-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ColumnChart extends IconSvgHost {
