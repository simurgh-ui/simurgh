...
import { definition } from '../definitions/chevrons-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevrons-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronsLeft extends IconSvgHost {
