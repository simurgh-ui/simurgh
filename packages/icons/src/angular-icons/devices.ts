...
import { definition } from '../definitions/devices.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-devices-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Devices extends IconSvgHost {
