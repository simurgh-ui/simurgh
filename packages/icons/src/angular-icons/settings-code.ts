...
@Component({ selector: 'simurgh-settings-code-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SettingsCode extends IconSvgHost {
