...
import { definition } from '../definitions/schedule.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-schedule-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Schedule extends IconSvgHost {
