...
import { definition } from '../definitions/shuffle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shuffle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Shuffle extends IconSvgHost {
