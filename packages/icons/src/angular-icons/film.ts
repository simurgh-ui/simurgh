...
import { definition } from '../definitions/film.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-film-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Film extends IconSvgHost {
