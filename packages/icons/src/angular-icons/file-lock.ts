...
import { definition } from '../definitions/file-lock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-lock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileLock extends IconSvgHost {
