...
@Component({ selector: 'simurgh-corner-down-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CornerDownRight extends IconSvgHost {
