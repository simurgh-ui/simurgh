...
import { definition } from '../definitions/memory.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-memory-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Memory extends IconSvgHost {
