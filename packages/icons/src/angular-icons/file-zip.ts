...
import { definition } from '../definitions/file-zip.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-zip-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileZip extends IconSvgHost {
