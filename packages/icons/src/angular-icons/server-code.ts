...
import { definition } from '../definitions/server-code.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-server-code-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ServerCode extends IconSvgHost {
