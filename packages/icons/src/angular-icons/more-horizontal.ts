...
import { definition } from '../definitions/more-horizontal.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-more-horizontal-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MoreHorizontal extends IconSvgHost {
