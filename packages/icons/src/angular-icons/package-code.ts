...
import { definition } from '../definitions/package-code.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-package-code-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PackageCode extends IconSvgHost {
