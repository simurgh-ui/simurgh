...
import { definition } from '../definitions/checkout.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-checkout-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Checkout extends IconSvgHost {
