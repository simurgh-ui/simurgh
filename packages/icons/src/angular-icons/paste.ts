...
import { definition } from '../definitions/paste.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-paste-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Paste extends IconSvgHost {
