...
@Component({ selector: 'simurgh-calendar-week-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarWeek extends IconSvgHost {
