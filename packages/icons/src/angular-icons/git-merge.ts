...
import { definition } from '../definitions/git-merge.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-git-merge-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class GitMerge extends IconSvgHost {
