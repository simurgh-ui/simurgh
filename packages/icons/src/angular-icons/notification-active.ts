...
import { definition } from '../definitions/notification-active.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-notification-active-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class NotificationActive extends IconSvgHost {
