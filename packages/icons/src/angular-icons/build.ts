...
import { definition } from '../definitions/build.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-build-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Build extends IconSvgHost {
