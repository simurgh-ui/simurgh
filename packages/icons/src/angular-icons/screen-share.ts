...
import { definition } from '../definitions/screen-share.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-screen-share-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ScreenShare extends IconSvgHost {
