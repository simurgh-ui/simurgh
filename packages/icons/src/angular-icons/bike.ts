...
import { definition } from '../definitions/bike.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bike-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Bike extends IconSvgHost {
