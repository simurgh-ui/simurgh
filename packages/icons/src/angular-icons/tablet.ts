...
import { definition } from '../definitions/tablet.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-tablet-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Tablet extends IconSvgHost {
