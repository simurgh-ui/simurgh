...
@Component({ selector: 'simurgh-folder-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderCheck extends IconSvgHost {
