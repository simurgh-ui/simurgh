...
import { definition } from '../definitions/info.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-info-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Info extends IconSvgHost {
