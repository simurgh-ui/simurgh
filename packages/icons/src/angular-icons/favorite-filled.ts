...
import { definition } from '../definitions/favorite-filled.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-favorite-filled-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FavoriteFilled extends IconSvgHost {
