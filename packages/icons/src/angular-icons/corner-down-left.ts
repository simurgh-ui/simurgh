...
@Component({ selector: 'simurgh-corner-down-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CornerDownLeft extends IconSvgHost {
