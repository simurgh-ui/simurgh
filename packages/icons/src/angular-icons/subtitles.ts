...
import { definition } from '../definitions/subtitles.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-subtitles-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Subtitles extends IconSvgHost {
