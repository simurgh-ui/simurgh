...
import { definition } from '../definitions/focus-mode.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-focus-mode-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FocusMode extends IconSvgHost {
