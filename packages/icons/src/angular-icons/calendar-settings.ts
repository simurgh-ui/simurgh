...
import { definition } from '../definitions/calendar-settings.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-settings-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarSettings extends IconSvgHost {
