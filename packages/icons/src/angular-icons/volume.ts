...
import { definition } from '../definitions/volume.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-volume-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Volume extends IconSvgHost {
