...
import { definition } from '../definitions/antivirus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-antivirus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Antivirus extends IconSvgHost {
