...
import { definition } from '../definitions/calendar-edit.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-edit-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarEdit extends IconSvgHost {
