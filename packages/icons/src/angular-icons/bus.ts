...
import { definition } from '../definitions/bus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Bus extends IconSvgHost {
