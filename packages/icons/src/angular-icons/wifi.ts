...
import { definition } from '../definitions/wifi.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-wifi-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Wifi extends IconSvgHost {
