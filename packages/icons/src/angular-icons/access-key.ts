...
import { definition } from '../definitions/access-key.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-access-key-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AccessKey extends IconSvgHost {
