...
import { definition } from '../definitions/file-audio.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-audio-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileAudio extends IconSvgHost {
