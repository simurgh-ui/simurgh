...
import { definition } from '../definitions/panel-top.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-panel-top-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PanelTop extends IconSvgHost {
