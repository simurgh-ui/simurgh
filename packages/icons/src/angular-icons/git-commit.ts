...
import { definition } from '../definitions/git-commit.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-git-commit-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class GitCommit extends IconSvgHost {
