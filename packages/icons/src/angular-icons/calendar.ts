...
import { definition } from '../definitions/calendar.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Calendar extends IconSvgHost {
