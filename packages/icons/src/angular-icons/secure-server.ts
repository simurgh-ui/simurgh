...
@Component({ selector: 'simurgh-secure-server-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SecureServer extends IconSvgHost {
