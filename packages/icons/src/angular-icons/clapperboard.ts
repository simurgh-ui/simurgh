...
import { definition } from '../definitions/clapperboard.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-clapperboard-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Clapperboard extends IconSvgHost {
