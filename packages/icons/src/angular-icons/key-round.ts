...
import { definition } from '../definitions/key-round.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-key-round-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class KeyRound extends IconSvgHost {
