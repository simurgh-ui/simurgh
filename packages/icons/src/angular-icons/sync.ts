...
import { definition } from '../definitions/sync.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-sync-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Sync extends IconSvgHost {
