...
import { definition } from '../definitions/user-x.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-x-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserX extends IconSvgHost {
