...
import { definition } from '../definitions/folder-minus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-minus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderMinus extends IconSvgHost {
