...
import { definition } from '../definitions/buildings.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-buildings-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Buildings extends IconSvgHost {
