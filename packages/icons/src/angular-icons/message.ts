...
import { definition } from '../definitions/message.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-message-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Message extends IconSvgHost {
