...
import { definition } from '../definitions/smartphone.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-smartphone-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Smartphone extends IconSvgHost {
