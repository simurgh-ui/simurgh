...
@Component({ selector: 'simurgh-percent-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PercentChart extends IconSvgHost {
