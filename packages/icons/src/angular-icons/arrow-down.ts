...
import { definition } from '../definitions/arrow-down.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-arrow-down-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ArrowDown extends IconSvgHost {
