...
import { definition } from '../definitions/archive.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-archive-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Archive extends IconSvgHost {
