...
import { definition } from '../definitions/swap.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-swap-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Swap extends IconSvgHost {
