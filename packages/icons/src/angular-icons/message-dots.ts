...
import { definition } from '../definitions/message-dots.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-message-dots-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MessageDots extends IconSvgHost {
