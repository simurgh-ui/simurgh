...
import { definition } from '../definitions/phone-missed.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-phone-missed-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PhoneMissed extends IconSvgHost {
