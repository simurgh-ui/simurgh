...
import { definition } from '../definitions/undo.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-undo-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Undo extends IconSvgHost {
