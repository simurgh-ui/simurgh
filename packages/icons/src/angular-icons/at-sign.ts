...
import { definition } from '../definitions/at-sign.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-at-sign-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AtSign extends IconSvgHost {
