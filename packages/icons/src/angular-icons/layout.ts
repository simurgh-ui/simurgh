...
import { definition } from '../definitions/layout.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Layout extends IconSvgHost {
