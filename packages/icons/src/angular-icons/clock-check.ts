...
import { definition } from '../definitions/clock-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-clock-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ClockCheck extends IconSvgHost {
