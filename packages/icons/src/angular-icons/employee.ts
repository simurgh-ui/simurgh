...
import { definition } from '../definitions/employee.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-employee-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Employee extends IconSvgHost {
