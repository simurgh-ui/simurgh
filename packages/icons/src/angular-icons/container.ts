...
import { definition } from '../definitions/container.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-container-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Container extends IconSvgHost {
