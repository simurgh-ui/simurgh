...
import { definition } from '../definitions/grid-2x2.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-grid-2x2-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Grid2x2 extends IconSvgHost {
