...
import { definition } from '../definitions/chevron-down.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevron-down-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronDown extends IconSvgHost {
