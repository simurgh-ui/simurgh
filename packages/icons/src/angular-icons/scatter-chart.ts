...
import { definition } from '../definitions/scatter-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-scatter-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ScatterChart extends IconSvgHost {
