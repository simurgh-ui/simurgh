...
@Component({ selector: 'simurgh-panel-bottom-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PanelBottom extends IconSvgHost {
