...
import { definition } from '../definitions/split-vertical.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-split-vertical-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SplitVertical extends IconSvgHost {
