...
import { definition } from '../definitions/headset.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-headset-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Headset extends IconSvgHost {
