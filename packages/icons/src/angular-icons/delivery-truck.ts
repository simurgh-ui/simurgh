...
@Component({ selector: 'simurgh-delivery-truck-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class DeliveryTruck extends IconSvgHost {
