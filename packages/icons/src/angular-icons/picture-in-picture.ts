...
import { definition } from '../definitions/picture-in-picture.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-picture-in-picture-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PictureInPicture extends IconSvgHost {
