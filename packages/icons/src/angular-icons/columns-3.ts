...
import { definition } from '../definitions/columns-3.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-columns-3-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Columns3 extends IconSvgHost {
