...
import { definition } from '../definitions/gallery.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-gallery-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Gallery extends IconSvgHost {
