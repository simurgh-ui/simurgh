...
import { definition } from '../definitions/building.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-building-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Building extends IconSvgHost {
