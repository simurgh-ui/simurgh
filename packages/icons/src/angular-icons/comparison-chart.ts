...
@Component({ selector: 'simurgh-comparison-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ComparisonChart extends IconSvgHost {
