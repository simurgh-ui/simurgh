...
import { definition } from '../definitions/location-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-location-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LocationPlus extends IconSvgHost {
