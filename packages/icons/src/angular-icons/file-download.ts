...
import { definition } from '../definitions/file-download.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-download-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileDownload extends IconSvgHost {
