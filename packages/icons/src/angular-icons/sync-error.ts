...
import { definition } from '../definitions/sync-error.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-sync-error-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SyncError extends IconSvgHost {
