...
import { definition } from '../definitions/landmark.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-landmark-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Landmark extends IconSvgHost {
