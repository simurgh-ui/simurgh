...
import { definition } from '../definitions/cash.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cash-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Cash extends IconSvgHost {
