...
import { definition } from '../definitions/tools.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-tools-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Tools extends IconSvgHost {
