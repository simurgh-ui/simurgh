...
import { definition } from '../definitions/lock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-lock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Lock extends IconSvgHost {
