...
import { definition } from '../definitions/messages.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-messages-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Messages extends IconSvgHost {
