...
import { definition } from '../definitions/account.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-account-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Account extends IconSvgHost {
