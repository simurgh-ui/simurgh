...
import { definition } from '../definitions/printer.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-printer-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Printer extends IconSvgHost {
