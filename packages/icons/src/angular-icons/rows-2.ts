...
import { definition } from '../definitions/rows-2.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-rows-2-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Rows2 extends IconSvgHost {
