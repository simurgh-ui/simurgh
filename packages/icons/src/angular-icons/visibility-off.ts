...
import { definition } from '../definitions/visibility-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-visibility-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VisibilityOff extends IconSvgHost {
