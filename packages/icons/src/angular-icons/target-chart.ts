...
import { definition } from '../definitions/target-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-target-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class TargetChart extends IconSvgHost {
