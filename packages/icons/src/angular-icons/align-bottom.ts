...
import { definition } from '../definitions/align-bottom.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-align-bottom-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlignBottom extends IconSvgHost {
