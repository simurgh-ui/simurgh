...
import { definition } from '../definitions/contacts.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-contacts-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Contacts extends IconSvgHost {
