...
import { definition } from '../definitions/zoom-in.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-zoom-in-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ZoomIn extends IconSvgHost {
