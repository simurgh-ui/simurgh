...
import { definition } from '../definitions/outbox.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-outbox-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Outbox extends IconSvgHost {
