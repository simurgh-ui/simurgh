...
import { definition } from '../definitions/image.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-image-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Image extends IconSvgHost {
