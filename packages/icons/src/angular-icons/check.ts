...
import { definition } from '../definitions/check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Check extends IconSvgHost {
