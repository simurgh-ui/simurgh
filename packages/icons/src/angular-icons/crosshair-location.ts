...
import { definition } from '../definitions/crosshair-location.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-crosshair-location-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CrosshairLocation extends IconSvgHost {
