...
@Component({ selector: 'simurgh-layout-footer-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutFooter extends IconSvgHost {
