...
import { definition } from '../definitions/calendar-clock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-clock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarClock extends IconSvgHost {
