...
@Component({ selector: 'simurgh-profile-card-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ProfileCard extends IconSvgHost {
