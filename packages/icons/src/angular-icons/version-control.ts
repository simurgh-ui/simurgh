...
import { definition } from '../definitions/version-control.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-version-control-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VersionControl extends IconSvgHost {
