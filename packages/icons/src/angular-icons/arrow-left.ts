...
import { definition } from '../definitions/arrow-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-arrow-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ArrowLeft extends IconSvgHost {
