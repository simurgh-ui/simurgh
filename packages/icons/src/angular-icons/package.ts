...
import { definition } from '../definitions/package.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-package-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Package extends IconSvgHost {
