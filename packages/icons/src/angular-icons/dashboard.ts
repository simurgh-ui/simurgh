...
import { definition } from '../definitions/dashboard.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-dashboard-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Dashboard extends IconSvgHost {
