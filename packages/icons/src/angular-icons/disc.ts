...
import { definition } from '../definitions/disc.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-disc-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Disc extends IconSvgHost {
