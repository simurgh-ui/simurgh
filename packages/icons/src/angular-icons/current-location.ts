...
import { definition } from '../definitions/current-location.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-current-location-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CurrentLocation extends IconSvgHost {
