...
import { definition } from '../definitions/progress-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-progress-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ProgressChart extends IconSvgHost {
