...
import { definition } from '../definitions/trend-up.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-trend-up-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class TrendUp extends IconSvgHost {
