...
import { definition } from '../definitions/success.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-success-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Success extends IconSvgHost {
