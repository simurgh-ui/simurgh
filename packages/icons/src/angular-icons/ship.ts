...
import { definition } from '../definitions/ship.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-ship-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Ship extends IconSvgHost {
