...
import { definition } from '../definitions/face-id.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-face-id-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FaceId extends IconSvgHost {
