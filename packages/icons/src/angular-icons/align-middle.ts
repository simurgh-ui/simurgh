...
import { definition } from '../definitions/align-middle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-align-middle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlignMiddle extends IconSvgHost {
