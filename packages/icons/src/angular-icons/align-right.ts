...
import { definition } from '../definitions/align-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-align-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlignRight extends IconSvgHost {
