...
import { definition } from '../definitions/star-filled.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-star-filled-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class StarFilled extends IconSvgHost {
