...
import { definition } from '../definitions/directions.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-directions-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Directions extends IconSvgHost {
