...
import { definition } from '../definitions/success-circle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-success-circle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SuccessCircle extends IconSvgHost {
