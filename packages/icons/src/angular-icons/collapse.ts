...
import { definition } from '../definitions/collapse.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-collapse-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Collapse extends IconSvgHost {
