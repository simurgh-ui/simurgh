...
import { definition } from '../definitions/align-center.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-align-center-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlignCenter extends IconSvgHost {
