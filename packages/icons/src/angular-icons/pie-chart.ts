...
import { definition } from '../definitions/pie-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-pie-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PieChart extends IconSvgHost {
