...
import { definition } from '../definitions/minimize.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-minimize-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Minimize extends IconSvgHost {
