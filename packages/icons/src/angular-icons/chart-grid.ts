...
import { definition } from '../definitions/chart-grid.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chart-grid-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartGrid extends IconSvgHost {
