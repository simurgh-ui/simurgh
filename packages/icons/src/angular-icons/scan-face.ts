...
import { definition } from '../definitions/scan-face.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-scan-face-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ScanFace extends IconSvgHost {
