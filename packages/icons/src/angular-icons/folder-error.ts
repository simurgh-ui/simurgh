...
import { definition } from '../definitions/folder-error.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-error-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderError extends IconSvgHost {
