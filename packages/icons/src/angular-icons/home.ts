...
import { definition } from '../definitions/home.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-home-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Home extends IconSvgHost {
