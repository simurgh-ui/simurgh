...
import { definition } from '../definitions/calendar-days.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-days-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarDays extends IconSvgHost {
