...
import { definition } from '../definitions/appointment.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-appointment-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Appointment extends IconSvgHost {
