...
import { definition } from '../definitions/unit-test.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-unit-test-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UnitTest extends IconSvgHost {
