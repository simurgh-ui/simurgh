...
import { definition } from '../definitions/align-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-align-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlignLeft extends IconSvgHost {
