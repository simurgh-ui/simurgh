...
import { definition } from '../definitions/store.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-store-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Store extends IconSvgHost {
