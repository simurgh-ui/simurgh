...
import { definition } from '../definitions/car.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-car-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Car extends IconSvgHost {
