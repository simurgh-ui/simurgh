...
import { definition } from '../definitions/screen-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-screen-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ScreenOff extends IconSvgHost {
