...
import { definition } from '../definitions/map-pin-filled.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-map-pin-filled-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MapPinFilled extends IconSvgHost {
