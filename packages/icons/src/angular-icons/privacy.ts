...
import { definition } from '../definitions/privacy.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-privacy-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Privacy extends IconSvgHost {
