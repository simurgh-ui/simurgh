...
import { definition } from '../definitions/cloud-file.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cloud-file-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CloudFile extends IconSvgHost {
