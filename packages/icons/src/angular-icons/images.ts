...
import { definition } from '../definitions/images.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-images-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Images extends IconSvgHost {
