...
import { definition } from '../definitions/corner-up-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-corner-up-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CornerUpLeft extends IconSvgHost {
