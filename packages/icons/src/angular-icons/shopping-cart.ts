...
import { definition } from '../definitions/shopping-cart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shopping-cart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ShoppingCart extends IconSvgHost {
