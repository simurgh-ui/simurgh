...
import { definition } from '../definitions/microphone-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-microphone-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MicrophoneOff extends IconSvgHost {
