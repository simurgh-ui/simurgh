...
import { definition } from '../definitions/layout-grid.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-grid-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutGrid extends IconSvgHost {
