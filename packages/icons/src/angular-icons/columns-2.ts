...
import { definition } from '../definitions/columns-2.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-columns-2-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Columns2 extends IconSvgHost {
