...
import { definition } from '../definitions/earth.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-earth-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Earth extends IconSvgHost {
