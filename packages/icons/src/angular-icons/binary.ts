...
import { definition } from '../definitions/binary.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-binary-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Binary extends IconSvgHost {
