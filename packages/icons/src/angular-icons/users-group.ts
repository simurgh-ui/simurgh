...
import { definition } from '../definitions/users-group.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-users-group-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UsersGroup extends IconSvgHost {
