...
import { definition } from '../definitions/edit.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-edit-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Edit extends IconSvgHost {
