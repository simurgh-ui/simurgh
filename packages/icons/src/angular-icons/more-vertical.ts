...
import { definition } from '../definitions/more-vertical.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-more-vertical-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MoreVertical extends IconSvgHost {
