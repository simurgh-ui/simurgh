...
import { definition } from '../definitions/authentication.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-authentication-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Authentication extends IconSvgHost {
