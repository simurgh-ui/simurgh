...
import { definition } from '../definitions/equalizer.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-equalizer-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Equalizer extends IconSvgHost {
