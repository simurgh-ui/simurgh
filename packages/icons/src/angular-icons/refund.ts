...
import { definition } from '../definitions/refund.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-refund-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Refund extends IconSvgHost {
