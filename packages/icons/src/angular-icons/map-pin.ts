...
import { definition } from '../definitions/map-pin.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-map-pin-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MapPin extends IconSvgHost {
