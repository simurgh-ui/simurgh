...
import { definition } from '../definitions/file-minus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-minus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileMinus extends IconSvgHost {
