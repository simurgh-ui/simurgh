...
import { definition } from '../definitions/package-open.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-package-open-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PackageOpen extends IconSvgHost {
