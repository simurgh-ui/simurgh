...
import { definition } from '../definitions/wifi-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-wifi-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class WifiOff extends IconSvgHost {
