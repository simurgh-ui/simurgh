...
@Component({ selector: 'simurgh-presentation-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PresentationChart extends IconSvgHost {
