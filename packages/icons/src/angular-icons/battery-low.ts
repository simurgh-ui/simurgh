...
import { definition } from '../definitions/battery-low.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-battery-low-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BatteryLow extends IconSvgHost {
