...
import { definition } from '../definitions/forward.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-forward-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Forward extends IconSvgHost {
