...
import { definition } from '../definitions/reply.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-reply-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Reply extends IconSvgHost {
