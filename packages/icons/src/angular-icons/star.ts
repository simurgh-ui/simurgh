...
import { definition } from '../definitions/star.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-star-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Star extends IconSvgHost {
