...
import { definition } from '../definitions/notification.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-notification-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Notification extends IconSvgHost {
