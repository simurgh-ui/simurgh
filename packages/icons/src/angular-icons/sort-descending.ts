...
import { definition } from '../definitions/sort-descending.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-sort-descending-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SortDescending extends IconSvgHost {
