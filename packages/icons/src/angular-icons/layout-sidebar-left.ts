...
import { definition } from '../definitions/layout-sidebar-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-sidebar-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutSidebarLeft extends IconSvgHost {
