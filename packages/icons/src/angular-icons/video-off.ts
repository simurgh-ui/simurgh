...
import { definition } from '../definitions/video-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-video-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VideoOff extends IconSvgHost {
