...
import { definition } from '../definitions/cut.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cut-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Cut extends IconSvgHost {
