...
import { definition } from '../definitions/moderator.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-moderator-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Moderator extends IconSvgHost {
