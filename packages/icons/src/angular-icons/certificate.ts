...
@Component({ selector: 'simurgh-certificate-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Certificate extends IconSvgHost {
