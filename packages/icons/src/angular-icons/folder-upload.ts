...
import { definition } from '../definitions/folder-upload.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-upload-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderUpload extends IconSvgHost {
