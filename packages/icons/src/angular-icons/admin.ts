...
import { definition } from '../definitions/admin.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-admin-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Admin extends IconSvgHost {
