...
import { definition } from '../definitions/badge-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-badge-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BadgeCheck extends IconSvgHost {
