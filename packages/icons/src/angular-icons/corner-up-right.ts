...
import { definition } from '../definitions/corner-up-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-corner-up-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CornerUpRight extends IconSvgHost {
