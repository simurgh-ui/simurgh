...
@Component({ selector: 'simurgh-chart-settings-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartSettings extends IconSvgHost {
