...
import { definition } from '../definitions/grid-3x3.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-grid-3x3-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Grid3x3 extends IconSvgHost {
