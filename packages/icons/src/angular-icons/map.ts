...
import { definition } from '../definitions/map.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-map-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Map extends IconSvgHost {
