...
import { definition } from '../definitions/basket.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-basket-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Basket extends IconSvgHost {
