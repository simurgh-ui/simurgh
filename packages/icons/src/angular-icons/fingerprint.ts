...
import { definition } from '../definitions/fingerprint.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-fingerprint-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Fingerprint extends IconSvgHost {
