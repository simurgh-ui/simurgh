...
import { definition } from '../definitions/folder-open.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-open-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderOpen extends IconSvgHost {
