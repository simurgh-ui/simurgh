...
import { definition } from '../definitions/warning.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-warning-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Warning extends IconSvgHost {
