...
import { definition } from '../definitions/deselect.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-deselect-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Deselect extends IconSvgHost {
