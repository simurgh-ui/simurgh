...
import { definition } from '../definitions/music-note.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-music-note-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MusicNote extends IconSvgHost {
