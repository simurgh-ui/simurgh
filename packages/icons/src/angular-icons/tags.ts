...
import { definition } from '../definitions/tags.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-tags-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Tags extends IconSvgHost {
