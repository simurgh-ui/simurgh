...
import { definition } from '../definitions/navigation-arrow.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-navigation-arrow-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class NavigationArrow extends IconSvgHost {
