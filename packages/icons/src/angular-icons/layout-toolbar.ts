...
import { definition } from '../definitions/layout-toolbar.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-toolbar-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutToolbar extends IconSvgHost {
