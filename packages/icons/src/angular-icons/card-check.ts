...
import { definition } from '../definitions/card-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-card-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CardCheck extends IconSvgHost {
