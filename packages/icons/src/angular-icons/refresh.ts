...
import { definition } from '../definitions/refresh.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-refresh-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Refresh extends IconSvgHost {
