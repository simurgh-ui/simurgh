...
import { definition } from '../definitions/flag.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-flag-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Flag extends IconSvgHost {
