...
import { definition } from '../definitions/braces.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-braces-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Braces extends IconSvgHost {
