...
import { definition } from '../definitions/help-circle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-help-circle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class HelpCircle extends IconSvgHost {
