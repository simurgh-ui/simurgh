...
import { definition } from '../definitions/mouse.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-mouse-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Mouse extends IconSvgHost {
