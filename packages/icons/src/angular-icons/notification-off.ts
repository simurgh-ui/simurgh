...
import { definition } from '../definitions/notification-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-notification-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class NotificationOff extends IconSvgHost {
