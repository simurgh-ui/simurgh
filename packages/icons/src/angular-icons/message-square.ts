...
import { definition } from '../definitions/message-square.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-message-square-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MessageSquare extends IconSvgHost {
