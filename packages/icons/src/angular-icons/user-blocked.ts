...
import { definition } from '../definitions/user-blocked.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-blocked-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserBlocked extends IconSvgHost {
