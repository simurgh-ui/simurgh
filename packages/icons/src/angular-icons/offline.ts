...
import { definition } from '../definitions/offline.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-offline-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Offline extends IconSvgHost {
