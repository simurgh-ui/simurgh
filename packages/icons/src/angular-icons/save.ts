...
import { definition } from '../definitions/save.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-save-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Save extends IconSvgHost {
