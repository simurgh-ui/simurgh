...
import { definition } from '../definitions/calendar-range.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-range-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarRange extends IconSvgHost {
