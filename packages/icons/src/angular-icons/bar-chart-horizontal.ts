...
@Component({ selector: 'simurgh-bar-chart-horizontal-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BarChartHorizontal extends IconSvgHost {
