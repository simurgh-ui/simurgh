...
import { definition } from '../definitions/copy.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-copy-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Copy extends IconSvgHost {
