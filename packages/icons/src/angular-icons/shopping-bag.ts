...
import { definition } from '../definitions/shopping-bag.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shopping-bag-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ShoppingBag extends IconSvgHost {
