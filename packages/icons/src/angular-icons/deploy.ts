...
import { definition } from '../definitions/deploy.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-deploy-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Deploy extends IconSvgHost {
