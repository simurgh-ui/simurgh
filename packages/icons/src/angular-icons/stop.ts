...
import { definition } from '../definitions/stop.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-stop-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Stop extends IconSvgHost {
