...
import { definition } from '../definitions/cart-x.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cart-x-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CartX extends IconSvgHost {
