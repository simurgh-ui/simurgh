...
import { definition } from '../definitions/trend-down.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-trend-down-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class TrendDown extends IconSvgHost {
