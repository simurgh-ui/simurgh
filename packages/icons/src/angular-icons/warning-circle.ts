...
import { definition } from '../definitions/warning-circle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-warning-circle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class WarningCircle extends IconSvgHost {
