...
import { definition } from '../definitions/chevrons-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevrons-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronsRight extends IconSvgHost {
