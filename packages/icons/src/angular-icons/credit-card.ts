...
import { definition } from '../definitions/credit-card.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-credit-card-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CreditCard extends IconSvgHost {
