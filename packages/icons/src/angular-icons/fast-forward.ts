...
import { definition } from '../definitions/fast-forward.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-fast-forward-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FastForward extends IconSvgHost {
