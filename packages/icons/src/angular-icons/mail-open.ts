...
import { definition } from '../definitions/mail-open.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-mail-open-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MailOpen extends IconSvgHost {
