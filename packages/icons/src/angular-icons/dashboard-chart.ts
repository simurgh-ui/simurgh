...
import { definition } from '../definitions/dashboard-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-dashboard-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class DashboardChart extends IconSvgHost {
