...
import { definition } from '../definitions/folders.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folders-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Folders extends IconSvgHost {
