...
import { definition } from '../definitions/error-circle.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-error-circle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ErrorCircle extends IconSvgHost {
