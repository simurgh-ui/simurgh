...
import { definition } from '../definitions/unlock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-unlock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Unlock extends IconSvgHost {
