...
import { definition } from '../definitions/cart-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cart-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CartPlus extends IconSvgHost {
