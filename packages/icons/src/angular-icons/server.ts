...
import { definition } from '../definitions/server.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-server-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Server extends IconSvgHost {
