...
import { definition } from '../definitions/database.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-database-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Database extends IconSvgHost {
