...
import { definition } from '../definitions/calendar-month.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-month-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarMonth extends IconSvgHost {
