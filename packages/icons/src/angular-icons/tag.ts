...
import { definition } from '../definitions/tag.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-tag-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Tag extends IconSvgHost {
