...
import { definition } from '../definitions/mail-notification.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-mail-notification-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class MailNotification extends IconSvgHost {
