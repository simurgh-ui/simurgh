...
import { definition } from '../definitions/panel-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-panel-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PanelRight extends IconSvgHost {
