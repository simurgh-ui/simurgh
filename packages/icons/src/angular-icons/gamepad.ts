...
import { definition } from '../definitions/gamepad.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-gamepad-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Gamepad extends IconSvgHost {
