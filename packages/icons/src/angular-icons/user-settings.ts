...
import { definition } from '../definitions/user-settings.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-settings-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserSettings extends IconSvgHost {
