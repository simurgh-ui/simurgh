...
import { definition } from '../definitions/calendar-x.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-x-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarX extends IconSvgHost {
