...
import { definition } from '../definitions/calendar-minus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-minus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarMinus extends IconSvgHost {
