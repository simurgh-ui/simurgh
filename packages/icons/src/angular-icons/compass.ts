...
import { definition } from '../definitions/compass.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-compass-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Compass extends IconSvgHost {
