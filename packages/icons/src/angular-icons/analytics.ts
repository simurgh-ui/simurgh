...
import { definition } from '../definitions/analytics.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-analytics-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Analytics extends IconSvgHost {
