...
import { definition } from '../definitions/coins.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-coins-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Coins extends IconSvgHost {
