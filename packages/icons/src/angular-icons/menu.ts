...
import { definition } from '../definitions/menu.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-menu-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Menu extends IconSvgHost {
