...
import { definition } from '../definitions/airplane.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-airplane-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Airplane extends IconSvgHost {
