...
import { definition } from '../definitions/skip-next.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-skip-next-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SkipNext extends IconSvgHost {
