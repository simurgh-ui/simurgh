...
import { definition } from '../definitions/cloud-code.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cloud-code-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CloudCode extends IconSvgHost {
