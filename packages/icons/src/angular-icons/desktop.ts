...
import { definition } from '../definitions/desktop.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-desktop-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Desktop extends IconSvgHost {
