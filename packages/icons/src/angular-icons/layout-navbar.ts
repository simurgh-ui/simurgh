...
import { definition } from '../definitions/layout-navbar.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-navbar-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutNavbar extends IconSvgHost {
