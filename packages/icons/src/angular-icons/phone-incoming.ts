...
@Component({ selector: 'simurgh-phone-incoming-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PhoneIncoming extends IconSvgHost {
