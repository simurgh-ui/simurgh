...
import { definition } from '../definitions/favorite.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-favorite-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Favorite extends IconSvgHost {
