...
@Component({ selector: 'simurgh-report-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ReportChart extends IconSvgHost {
