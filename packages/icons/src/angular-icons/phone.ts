...
import { definition } from '../definitions/phone.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-phone-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Phone extends IconSvgHost {
