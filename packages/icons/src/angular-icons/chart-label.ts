...
import { definition } from '../definitions/chart-label.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chart-label-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartLabel extends IconSvgHost {
