...
import { definition } from '../definitions/maximize.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-maximize-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Maximize extends IconSvgHost {
