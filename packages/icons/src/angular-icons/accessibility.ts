...
import { definition } from '../definitions/accessibility.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-accessibility-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Accessibility extends IconSvgHost {
