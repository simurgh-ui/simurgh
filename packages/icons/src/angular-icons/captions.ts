...
import { definition } from '../definitions/captions.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-captions-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Captions extends IconSvgHost {
