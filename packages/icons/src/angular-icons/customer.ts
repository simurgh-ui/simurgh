...
import { definition } from '../definitions/customer.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-customer-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Customer extends IconSvgHost {
