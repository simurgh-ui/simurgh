...
import { definition } from '../definitions/alarm-off.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-alarm-off-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AlarmOff extends IconSvgHost {
