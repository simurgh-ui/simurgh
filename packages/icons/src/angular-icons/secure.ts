...
import { definition } from '../definitions/secure.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-secure-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Secure extends IconSvgHost {
