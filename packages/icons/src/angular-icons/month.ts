...
import { definition } from '../definitions/month.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-month-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Month extends IconSvgHost {
