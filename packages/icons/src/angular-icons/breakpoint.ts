...
import { definition } from '../definitions/breakpoint.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-breakpoint-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Breakpoint extends IconSvgHost {
