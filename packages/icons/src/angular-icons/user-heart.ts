...
import { definition } from '../definitions/user-heart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-heart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserHeart extends IconSvgHost {
