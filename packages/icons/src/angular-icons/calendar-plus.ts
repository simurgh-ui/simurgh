...
import { definition } from '../definitions/calendar-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarPlus extends IconSvgHost {
