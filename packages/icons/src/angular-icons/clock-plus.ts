...
import { definition } from '../definitions/clock-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-clock-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ClockPlus extends IconSvgHost {
