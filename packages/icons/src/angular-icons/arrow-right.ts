...
import { definition } from '../definitions/arrow-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-arrow-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ArrowRight extends IconSvgHost {
