...
import { definition } from '../definitions/files.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-files-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Files extends IconSvgHost {
