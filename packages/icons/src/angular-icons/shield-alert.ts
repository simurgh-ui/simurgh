...
@Component({ selector: 'simurgh-shield-alert-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ShieldAlert extends IconSvgHost {
