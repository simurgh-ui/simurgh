...
import { definition } from '../definitions/video.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-video-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Video extends IconSvgHost {
