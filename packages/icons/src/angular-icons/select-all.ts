...
import { definition } from '../definitions/select-all.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-select-all-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SelectAll extends IconSvgHost {
