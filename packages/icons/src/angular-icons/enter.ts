...
import { definition } from '../definitions/enter.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-enter-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Enter extends IconSvgHost {
