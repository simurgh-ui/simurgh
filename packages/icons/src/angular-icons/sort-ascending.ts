...
@Component({ selector: 'simurgh-sort-ascending-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SortAscending extends IconSvgHost {
