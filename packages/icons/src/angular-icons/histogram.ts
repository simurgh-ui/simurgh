...
import { definition } from '../definitions/histogram.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-histogram-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Histogram extends IconSvgHost {
