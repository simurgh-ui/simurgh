...
import { definition } from '../definitions/route-map.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-route-map-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class RouteMap extends IconSvgHost {
