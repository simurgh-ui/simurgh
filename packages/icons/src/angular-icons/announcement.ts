...
@Component({ selector: 'simurgh-announcement-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Announcement extends IconSvgHost {
