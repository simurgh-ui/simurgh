...
import { definition } from '../definitions/shield.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shield-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Shield extends IconSvgHost {
