...
import { definition } from '../definitions/zoom-out.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-zoom-out-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ZoomOut extends IconSvgHost {
