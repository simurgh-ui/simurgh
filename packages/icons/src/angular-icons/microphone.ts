...
import { definition } from '../definitions/microphone.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-microphone-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Microphone extends IconSvgHost {
