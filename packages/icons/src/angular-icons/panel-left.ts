...
import { definition } from '../definitions/panel-left.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-panel-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PanelLeft extends IconSvgHost {
