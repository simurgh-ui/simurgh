...
import { definition } from '../definitions/inbox.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-inbox-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Inbox extends IconSvgHost {
