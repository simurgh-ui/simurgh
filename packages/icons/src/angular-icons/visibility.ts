...
import { definition } from '../definitions/visibility.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-visibility-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Visibility extends IconSvgHost {
