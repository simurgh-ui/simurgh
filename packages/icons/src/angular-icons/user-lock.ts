...
import { definition } from '../definitions/user-lock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-lock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserLock extends IconSvgHost {
