...
import { definition } from '../definitions/security-scan.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-security-scan-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SecurityScan extends IconSvgHost {
