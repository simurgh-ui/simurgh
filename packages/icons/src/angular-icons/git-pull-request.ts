...
import { definition } from '../definitions/git-pull-request.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-git-pull-request-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class GitPullRequest extends IconSvgHost {
