...
import { definition } from '../definitions/shield-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shield-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ShieldCheck extends IconSvgHost {
