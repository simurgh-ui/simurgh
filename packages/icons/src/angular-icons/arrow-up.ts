...
import { definition } from '../definitions/arrow-up.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-arrow-up-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ArrowUp extends IconSvgHost {
