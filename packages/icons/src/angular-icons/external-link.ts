...
import { definition } from '../definitions/external-link.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-external-link-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ExternalLink extends IconSvgHost {
