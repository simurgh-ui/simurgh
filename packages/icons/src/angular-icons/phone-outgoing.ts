...
import { definition } from '../definitions/phone-outgoing.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-phone-outgoing-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class PhoneOutgoing extends IconSvgHost {
