...
@Component({ selector: 'simurgh-verified-user-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VerifiedUser extends IconSvgHost {
