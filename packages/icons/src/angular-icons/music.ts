...
import { definition } from '../definitions/music.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-music-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Music extends IconSvgHost {
