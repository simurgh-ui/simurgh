...
import { definition } from '../definitions/trash.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-trash-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Trash extends IconSvgHost {
