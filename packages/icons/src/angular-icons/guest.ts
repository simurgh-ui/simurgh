...
import { definition } from '../definitions/guest.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-guest-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Guest extends IconSvgHost {
