...
import { definition } from '../definitions/redo.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-redo-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Redo extends IconSvgHost {
