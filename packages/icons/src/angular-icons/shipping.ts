...
import { definition } from '../definitions/shipping.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shipping-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Shipping extends IconSvgHost {
