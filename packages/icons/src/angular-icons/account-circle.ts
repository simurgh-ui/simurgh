...
@Component({ selector: 'simurgh-account-circle-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AccountCircle extends IconSvgHost {
