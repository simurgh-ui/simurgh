...
import { definition } from '../definitions/file-pdf.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-pdf-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FilePdf extends IconSvgHost {
