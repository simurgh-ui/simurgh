...
import { definition } from '../definitions/area-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-area-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class AreaChart extends IconSvgHost {
