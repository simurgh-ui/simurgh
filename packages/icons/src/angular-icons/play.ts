...
import { definition } from '../definitions/play.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-play-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Play extends IconSvgHost {
