...
import { definition } from '../definitions/webcam.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-webcam-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Webcam extends IconSvgHost {
