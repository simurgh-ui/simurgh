...
import { definition } from '../definitions/user-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserPlus extends IconSvgHost {
