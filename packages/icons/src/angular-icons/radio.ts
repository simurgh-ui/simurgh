...
import { definition } from '../definitions/radio.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-radio-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Radio extends IconSvgHost {
