...
import { definition } from '../definitions/secure-cloud.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-secure-cloud-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SecureCloud extends IconSvgHost {
