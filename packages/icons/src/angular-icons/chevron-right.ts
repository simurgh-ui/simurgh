...
import { definition } from '../definitions/chevron-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevron-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronRight extends IconSvgHost {
