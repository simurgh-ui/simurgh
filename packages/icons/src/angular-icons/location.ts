...
import { definition } from '../definitions/location.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-location-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Location extends IconSvgHost {
