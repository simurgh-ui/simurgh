...
import { definition } from '../definitions/layout-rows.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-rows-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutRows extends IconSvgHost {
