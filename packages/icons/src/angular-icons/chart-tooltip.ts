...
@Component({ selector: 'simurgh-chart-tooltip-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartTooltip extends IconSvgHost {
