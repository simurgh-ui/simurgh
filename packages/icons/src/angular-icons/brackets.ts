...
import { definition } from '../definitions/brackets.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-brackets-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Brackets extends IconSvgHost {
