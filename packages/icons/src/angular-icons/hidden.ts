...
import { definition } from '../definitions/hidden.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-hidden-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Hidden extends IconSvgHost {
