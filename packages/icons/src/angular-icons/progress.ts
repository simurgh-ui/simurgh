...
import { definition } from '../definitions/progress.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-progress-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Progress extends IconSvgHost {
