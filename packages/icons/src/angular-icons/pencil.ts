...
import { definition } from '../definitions/pencil.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-pencil-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Pencil extends IconSvgHost {
