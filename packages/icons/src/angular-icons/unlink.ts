...
import { definition } from '../definitions/unlink.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-unlink-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Unlink extends IconSvgHost {
