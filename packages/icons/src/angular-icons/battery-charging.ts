...
import { definition } from '../definitions/battery-charging.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-battery-charging-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BatteryCharging extends IconSvgHost {
