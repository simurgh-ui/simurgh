...
import { definition } from '../definitions/receipt.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-receipt-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Receipt extends IconSvgHost {
