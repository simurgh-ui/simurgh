...
import { definition } from '../definitions/warehouse.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-warehouse-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Warehouse extends IconSvgHost {
