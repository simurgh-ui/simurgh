...
import { definition } from '../definitions/eject.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-eject-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Eject extends IconSvgHost {
