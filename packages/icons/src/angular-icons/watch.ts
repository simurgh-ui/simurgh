...
import { definition } from '../definitions/watch.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-watch-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Watch extends IconSvgHost {
