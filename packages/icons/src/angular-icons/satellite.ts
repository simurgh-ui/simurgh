...
import { definition } from '../definitions/satellite.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-satellite-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Satellite extends IconSvgHost {
