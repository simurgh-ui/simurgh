...
import { definition } from '../definitions/folder-download.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-download-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderDownload extends IconSvgHost {
