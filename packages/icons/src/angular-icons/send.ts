...
import { definition } from '../definitions/send.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-send-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Send extends IconSvgHost {
