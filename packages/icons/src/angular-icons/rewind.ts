...
import { definition } from '../definitions/rewind.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-rewind-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Rewind extends IconSvgHost {
