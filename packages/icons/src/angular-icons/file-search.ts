...
import { definition } from '../definitions/file-search.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-search-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileSearch extends IconSvgHost {
