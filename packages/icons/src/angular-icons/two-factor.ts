...
import { definition } from '../definitions/two-factor.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-two-factor-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class TwoFactor extends IconSvgHost {
