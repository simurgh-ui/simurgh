...
@Component({ selector: 'simurgh-chevron-left-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronLeft extends IconSvgHost {
