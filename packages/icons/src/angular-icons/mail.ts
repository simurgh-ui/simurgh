...
import { definition } from '../definitions/mail.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-mail-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Mail extends IconSvgHost {
