...
@Component({ selector: 'simurgh-clipboard-text-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ClipboardText extends IconSvgHost {
