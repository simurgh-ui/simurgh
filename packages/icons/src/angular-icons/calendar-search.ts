...
@Component({ selector: 'simurgh-calendar-search-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarSearch extends IconSvgHost {
