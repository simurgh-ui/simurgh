...
import { definition } from '../definitions/location-x.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-location-x-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LocationX extends IconSvgHost {
