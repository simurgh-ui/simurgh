...
import { definition } from '../definitions/folder-search.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-search-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderSearch extends IconSvgHost {
