...
import { definition } from '../definitions/download.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-download-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Download extends IconSvgHost {
