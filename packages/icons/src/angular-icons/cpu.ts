...
import { definition } from '../definitions/cpu.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cpu-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Cpu extends IconSvgHost {
