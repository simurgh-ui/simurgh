...
import { definition } from '../definitions/chevron-up.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevron-up-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronUp extends IconSvgHost {
