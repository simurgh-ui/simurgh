...
@Component({ selector: 'simurgh-split-horizontal-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SplitHorizontal extends IconSvgHost {
