...
import { definition } from '../definitions/loading.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-loading-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Loading extends IconSvgHost {
