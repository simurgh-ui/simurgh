...
import { definition } from '../definitions/verified.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-verified-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Verified extends IconSvgHost {
