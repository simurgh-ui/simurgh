...
import { definition } from '../definitions/terminal.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-terminal-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Terminal extends IconSvgHost {
