...
import { definition } from '../definitions/bar-chart-stacked.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bar-chart-stacked-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BarChartStacked extends IconSvgHost {
