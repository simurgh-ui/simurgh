...
import { definition } from '../definitions/laptop.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-laptop-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Laptop extends IconSvgHost {
