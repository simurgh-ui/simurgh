...
import { definition } from '../definitions/chart-axis.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chart-axis-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartAxis extends IconSvgHost {
