...
import { definition } from '../definitions/layout-dashboard.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-dashboard-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutDashboard extends IconSvgHost {
