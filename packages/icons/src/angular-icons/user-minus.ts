...
import { definition } from '../definitions/user-minus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-minus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserMinus extends IconSvgHost {
