...
import { definition } from '../definitions/file-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FilePlus extends IconSvgHost {
