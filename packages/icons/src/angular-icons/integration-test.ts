...
@Component({ selector: 'simurgh-integration-test-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class IntegrationTest extends IconSvgHost {
