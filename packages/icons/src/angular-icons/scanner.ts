...
import { definition } from '../definitions/scanner.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-scanner-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Scanner extends IconSvgHost {
