...
import { definition } from '../definitions/error.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-error-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Error extends IconSvgHost {
