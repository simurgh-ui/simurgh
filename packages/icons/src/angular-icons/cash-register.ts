...
import { definition } from '../definitions/cash-register.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cash-register-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CashRegister extends IconSvgHost {
