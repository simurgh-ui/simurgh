...
import { definition } from '../definitions/megaphone.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-megaphone-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Megaphone extends IconSvgHost {
