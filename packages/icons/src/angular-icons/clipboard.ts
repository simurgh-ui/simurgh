...
import { definition } from '../definitions/clipboard.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-clipboard-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Clipboard extends IconSvgHost {
