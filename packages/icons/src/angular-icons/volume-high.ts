...
import { definition } from '../definitions/volume-high.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-volume-high-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VolumeHigh extends IconSvgHost {
