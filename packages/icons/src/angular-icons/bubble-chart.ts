...
import { definition } from '../definitions/bubble-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bubble-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BubbleChart extends IconSvgHost {
