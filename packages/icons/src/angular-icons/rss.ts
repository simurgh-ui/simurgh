...
import { definition } from '../definitions/rss.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-rss-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Rss extends IconSvgHost {
