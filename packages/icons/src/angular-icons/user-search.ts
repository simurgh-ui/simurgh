...
import { definition } from '../definitions/user-search.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-search-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserSearch extends IconSvgHost {
