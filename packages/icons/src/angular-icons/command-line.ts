...
import { definition } from '../definitions/command-line.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-command-line-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CommandLine extends IconSvgHost {
