...
import { definition } from '../definitions/data-table.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-data-table-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class DataTable extends IconSvgHost {
