...
import { definition } from '../definitions/calendar-event.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-event-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarEvent extends IconSvgHost {
