...
import { definition } from '../definitions/file-error.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-error-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileError extends IconSvgHost {
