...
import { definition } from '../definitions/file-text.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-file-text-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FileText extends IconSvgHost {
