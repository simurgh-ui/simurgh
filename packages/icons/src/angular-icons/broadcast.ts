...
import { definition } from '../definitions/broadcast.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-broadcast-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Broadcast extends IconSvgHost {
