...
import { definition } from '../definitions/folder-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-folder-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class FolderPlus extends IconSvgHost {
