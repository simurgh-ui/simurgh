...
import { definition } from '../definitions/globe.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-globe-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Globe extends IconSvgHost {
