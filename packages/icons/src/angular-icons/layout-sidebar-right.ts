...
import { definition } from '../definitions/layout-sidebar-right.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-sidebar-right-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutSidebarRight extends IconSvgHost {
