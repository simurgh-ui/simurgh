...
import { definition } from '../definitions/playlist.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-playlist-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Playlist extends IconSvgHost {
