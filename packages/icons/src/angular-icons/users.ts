...
import { definition } from '../definitions/users.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-users-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Users extends IconSvgHost {
