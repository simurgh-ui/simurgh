...
import { definition } from '../definitions/bug-shield.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bug-shield-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class BugShield extends IconSvgHost {
