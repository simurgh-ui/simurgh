...
import { definition } from '../definitions/location-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-location-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LocationCheck extends IconSvgHost {
