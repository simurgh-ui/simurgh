...
import { definition } from '../definitions/signpost.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-signpost-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Signpost extends IconSvgHost {
