...
import { definition } from '../definitions/chevrons-up.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevrons-up-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronsUp extends IconSvgHost {
