...
import { definition } from '../definitions/security-warning.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-security-warning-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class SecurityWarning extends IconSvgHost {
