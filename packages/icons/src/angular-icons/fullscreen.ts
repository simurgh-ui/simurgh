...
import { definition } from '../definitions/fullscreen.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-fullscreen-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Fullscreen extends IconSvgHost {
