...
import { definition } from '../definitions/clock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-clock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Clock extends IconSvgHost {
