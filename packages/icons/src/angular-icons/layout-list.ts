...
import { definition } from '../definitions/layout-list.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-list-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutList extends IconSvgHost {
