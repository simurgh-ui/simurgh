...
import { definition } from '../definitions/waveform.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-waveform-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Waveform extends IconSvgHost {
