...
import { definition } from '../definitions/day.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-day-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Day extends IconSvgHost {
