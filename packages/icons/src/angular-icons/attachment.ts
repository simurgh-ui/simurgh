...
import { definition } from '../definitions/attachment.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-attachment-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Attachment extends IconSvgHost {
