...
import { definition } from '../definitions/share.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-share-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Share extends IconSvgHost {
