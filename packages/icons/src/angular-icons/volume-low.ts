...
import { definition } from '../definitions/volume-low.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-volume-low-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class VolumeLow extends IconSvgHost {
