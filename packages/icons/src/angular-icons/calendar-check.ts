...
import { definition } from '../definitions/calendar-check.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-calendar-check-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class CalendarCheck extends IconSvgHost {
