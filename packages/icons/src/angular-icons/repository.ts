...
import { definition } from '../definitions/repository.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-repository-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Repository extends IconSvgHost {
