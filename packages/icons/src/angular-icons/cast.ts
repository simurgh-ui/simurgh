...
import { definition } from '../definitions/cast.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-cast-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Cast extends IconSvgHost {
