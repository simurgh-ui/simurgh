...
import { definition } from '../definitions/print.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-print-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Print extends IconSvgHost {
