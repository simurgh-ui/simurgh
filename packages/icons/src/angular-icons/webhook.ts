...
import { definition } from '../definitions/webhook.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-webhook-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Webhook extends IconSvgHost {
