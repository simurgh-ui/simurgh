...
import { definition } from '../definitions/layout-columns.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-layout-columns-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class LayoutColumns extends IconSvgHost {
