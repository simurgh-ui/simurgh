...
import { definition } from '../definitions/bug.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-bug-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Bug extends IconSvgHost {
