...
import { definition } from '../definitions/invoice.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-invoice-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Invoice extends IconSvgHost {
