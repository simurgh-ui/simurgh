...
import { definition } from '../definitions/plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Plus extends IconSvgHost {
