...
import { definition } from '../definitions/keyboard.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-keyboard-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Keyboard extends IconSvgHost {
