...
import { definition } from '../definitions/user-edit.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-user-edit-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class UserEdit extends IconSvgHost {
