...
import { definition } from '../definitions/chevrons-down.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chevrons-down-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChevronsDown extends IconSvgHost {
