...
import { definition } from '../definitions/reminder.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-reminder-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Reminder extends IconSvgHost {
