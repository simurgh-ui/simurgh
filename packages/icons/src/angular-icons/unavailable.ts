...
import { definition } from '../definitions/unavailable.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-unavailable-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Unavailable extends IconSvgHost {
