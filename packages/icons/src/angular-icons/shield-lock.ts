...
import { definition } from '../definitions/shield-lock.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-shield-lock-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ShieldLock extends IconSvgHost {
