...
import { definition } from '../definitions/contact.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-contact-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Contact extends IconSvgHost {
