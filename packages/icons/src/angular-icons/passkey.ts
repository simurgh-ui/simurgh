...
import { definition } from '../definitions/passkey.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-passkey-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class Passkey extends IconSvgHost {
