...
import { definition } from '../definitions/activity-chart.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-activity-chart-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ActivityChart extends IconSvgHost {
