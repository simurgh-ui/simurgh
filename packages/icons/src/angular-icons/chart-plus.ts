...
import { definition } from '../definitions/chart-plus.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chart-plus-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartPlus extends IconSvgHost {
