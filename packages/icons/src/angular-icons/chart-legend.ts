...
import { definition } from '../definitions/chart-legend.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-chart-legend-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class ChartLegend extends IconSvgHost {
