...
import { definition } from '../definitions/rotate-clockwise.js';
import type { IconDefinition } from '../types.js';
@Component({ selector: 'simurgh-rotate-clockwise-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class RotateClockwise extends IconSvgHost {
