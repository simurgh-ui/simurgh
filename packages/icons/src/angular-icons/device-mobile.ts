...
@Component({ selector: 'simurgh-device-mobile-icon', standalone: true, changeDetection: ChangeDetectionStrategy.OnPush,
...
export class DeviceMobile extends IconSvgHost {
