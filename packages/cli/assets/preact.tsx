...
export type { SheetSide } from './components/sheet.js';
export {
  Drawer,
  DrawerTrigger,
  DrawerContent,
...
export type { ComboboxProps, SelectOption } from './components/combobox.js';
...
export { ToastProvider, useToast, ToastViewport } from './components/toast.js';
...
function SeriesMarks<T>({ item, index, baseline, bandwidth, orientation, visualMap }: { item: PreparedSeries<T>; index: number; baseline: number; bandwidth: number; orientation: string; visualMap: ChartVisualMap | undefined }) {
  ...
  if (item.type === 'line') return <g data-part="series" data-series={item.id}><path d={chartCurvePath(points, item.curve, item.tension)} fill="none" stroke={color} strokeWidth={item.lineWidth} strokeDasharray={item.lineDash} />{item.pointSymbol && item.points.map((point) => item.pointSymbol === 'square' ? <rect key={point.index} data-part="point-symbol" x={point.x - 3} y={point.y - 3} width="6" height="6" fill={fill} /> : item.pointSymbol === 'diamond' ? <path key={point.index} data-part="point-symbol" d={`M${point.x},${point.y - 4}L${point.x + 4},${point.y}L${point.x},${point.y + 4}L${point.x - 4},${point.y}Z`} fill={fill} /> : <circle key={point.index} data-part="point-symbol" cx={point.x} cy={point.y} r="3" fill={fill} />)}</g>;
...
// @ts-nocheck -- generated compatibility implementation; public declarations use Preact types.
// Generated from @simurgh-ui/react for Preact compatibility. Do not edit directly.
import { type HTMLAttributes, type PropsWithChildren } from 'preact/compat';
import {
  FloatingContent,
  FloatingRoot,
  FloatingTrigger,
...
// @ts-nocheck -- generated compatibility implementation; public declarations use Preact types.
// Generated from @simurgh-ui/react for Preact compatibility. Do not edit directly.
import { forwardRef, type LabelHTMLAttributes } from 'preact/compat';
...
// @ts-nocheck -- generated compatibility implementation; public declarations use Preact types.
// Generated from @simurgh-ui/react for Preact compatibility. Do not edit directly.
import { forwardRef, type AnchorHTMLAttributes } from 'preact/compat';
...
// @ts-nocheck -- generated compatibility implementation; public declarations use Preact types.
// Generated from @simurgh-ui/react for Preact compatibility. Do not edit directly.
import { forwardRef, useId, useState, type HTMLAttributes } from 'preact/compat';
import { useFormReset } from '../internal/forms.js';
