...
const groups = {
  ...
  playback: ['play', 'pause', 'stop', 'skip-next', 'skip-previous', 'fast-forward', 'rewind', 'eject', 'repeat'],
  'media-audio': ['volume', 'volume-low', 'volume-high', 'volume-off', 'music', 'music-note', 'playlist', 'radio'],
  'visual-media': ['image', 'images', 'camera', 'camera-off', 'film', 'clapperboard', 'gallery', 'picture-in-picture'],
  'media-content': ['captions', 'subtitles', 'equalizer', 'waveform', 'podcast', 'disc', 'cast'],
  shopping: ['shopping-cart', 'cart-plus', 'cart-minus', 'cart-check', 'cart-x', 'shopping-bag', 'basket', 'store'],
  fulfillment: ['package', 'package-open', 'package-check', 'package-x', 'delivery-truck', 'shipping', 'warehouse', 'barcode'],
  payments: ['credit-card', 'card-check', 'wallet', 'cash', 'banknote', 'coins', 'receipt', 'invoice'],
  pricing: ['tag', 'tags', 'coupon', 'percent', 'gift', 'cash-register', 'checkout', 'refund'],
  charts: ['bar-chart', 'bar-chart-horizontal', 'bar-chart-stacked', 'column-chart', 'line-chart', 'area-chart', 'pie-chart', 'donut-chart'],
  'statistical-charts': ['trend-up', 'trend-down', 'activity-chart', 'scatter-chart', 'bubble-chart', 'radar-chart', 'gauge', 'histogram'],
  'chart-interface': ['chart-grid', 'chart-axis', 'chart-label', 'chart-legend', 'chart-tooltip', 'data-table', 'analytics', 'dashboard-chart'],
  'chart-actions': ['percent-chart', 'progress-chart', 'target-chart', 'comparison-chart', 'report-chart', 'presentation-chart', 'chart-plus', 'chart-settings'],
  devices: ['monitor', 'laptop', 'desktop', 'tablet', 'smartphone', 'watch', 'keyboard', 'mouse'],
  hardware: ['printer', 'scanner', 'router', 'server', 'hard-drive', 'cpu', 'memory', 'usb'],
  connectivity: ['battery', 'battery-low', 'battery-charging', 'power', 'plug', 'wifi', 'wifi-off', 'bluetooth'],
  'device-actions': ['device-mobile', 'device-desktop', 'devices', 'screen-share', 'screen-off', 'cast-device', 'gamepad', 'webcam'],
  'access-control': ['lock', 'unlock', 'lock-keyhole', 'shield', 'shield-check', 'shield-x', 'shield-alert', 'shield-lock'],
  'identity-security': ['key', 'key-round', 'fingerprint', 'face-id', 'scan-face', 'password', 'pin-code', 'access-key'],
  'privacy-security': ['privacy', 'incognito', 'hidden', 'firewall', 'antivirus', 'bug-shield', 'secure-server', 'secure-cloud'],
  authentication: ['authentication', 'two-factor', 'verified-user', 'user-blocked', 'certificate', 'passkey', 'security-scan', 'security-warning'],
  mapping: ['map', 'map-pin', 'map-pin-filled', 'map-pinned', 'navigation-arrow', 'compass-map', 'route-map', 'directions'],
  'location-services': ['location', 'location-check', 'location-x', 'location-plus', 'current-location', 'crosshair-location', 'gps', 'satellite'],
  geography: ['globe', 'globe-alt', 'earth', 'landmark', 'building', 'buildings', 'road', 'signpost'],
  transportation: ['car', 'bus', 'train', 'airplane', 'ship', 'bike', 'walking', 'flag'],
  coding: ['code', 'code-alt', 'terminal', 'command-line', 'braces', 'brackets', 'binary', 'regex'],
  'version-control': ['git-branch', 'git-commit', 'git-merge', 'git-pull-request', 'git-fork', 'version-control', 'repository', 'package-code'],
  'testing-delivery': ['bug', 'debug', 'breakpoint', 'unit-test', 'integration-test', 'deploy', 'rocket', 'build'],
  'development-infrastructure': ['api', 'webhook', 'database', 'cloud-code', 'server-code', 'container', 'settings-code', 'tools'],
};
